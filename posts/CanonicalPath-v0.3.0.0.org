...
You wouldn't expect that, but in this post I announce third major release of ~CanonicalPath~ library. It should help you to canonicalize paths on your computer. And here is a funny fact about myself: I like to surround version numbers with zeros (one zero goes to the very left and another one to the very right).

I am making major release instead of minor because I have broken API (just a little bit). But I hope that you will like it. OK, so what's new?
